...
<html>
	...
	//Sorting
	Deliverable[] deliverablesOriginal = assignments[assignments.length - 1].getDeliverables();
	ArrayList<Deliverable> deliverablesList = new ArrayList<Deliverable>();
	for(int i = 0; i < deliverablesOriginal.length; i++) {
		Deliverable deliverable = deliverablesOriginal[i];
	...
	Deliverable[] deliverablesCopy = new Deliverable[deliverablesOriginal.length];
	for(int i = 0; i < deliverablesOriginal.length; i++) {
		deliverablesCopy[i] = deliverablesList.get(i);
	}	
	assignments[assignments.length - 1].setDeliverables(deliverablesCopy); 
	for(int i = 0; i < assignments.length - 1; i++) {
		assignments[i] = assignmentsList.get(i);
	}
